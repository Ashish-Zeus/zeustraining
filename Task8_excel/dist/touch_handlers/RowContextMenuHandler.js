...
export class RowContextMenuHandler {
    constructor() {
        this.grid = null;
    }
    /**
    ...
    onPointerDown(e) {
        ...
        menuItems.push({
            ...
            action: () => this.grid.getHistoryManager().addAndExecute(new InsertRowCommand(row, clickedRowHeight)),
        });
        menuItems.push({
            label: "Insert Row Below",
            action: () => this.grid.getHistoryManager().addAndExecute(new InsertRowCommand(row + 1, clickedRowHeight)),
        });
        ...
        menuItems.push({
            label: "Delete Row",
            action: () => this.grid.getHistoryManager().addAndExecute(new DeleteRowCommand(row, this.grid)),
        });
